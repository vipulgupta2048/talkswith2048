...
This repository acts as a showcase of all talks/workshops that Vipul Gupta (vipulgupta2048) took over the years along with acting as a backup of all resources and material shown for anyone to use, reference and guide. Adding on to it, it is also a tracker of conferences that is attended, volunteered by him.   
...
| --- |:---:|---|
| PyDelhi Conference 2017 | [Website](https://conference.pydelhi.org) | Attendee - My first conference |
