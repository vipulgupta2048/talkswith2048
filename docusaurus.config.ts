...
const config = {
  ...
  /** @type {import('@docusaurus/preset-classic').ThemeConfig} */
  {
    ...
    footer: {
      links: [
        {
          html: `Docs written, not generated by @${org} 💜</br><a href="${githubUrl}/issues/new?assignees=vipulgupta2048&labels=&projects=&template=welcome-ideas.md&title=user-feedback">Steal responsibly</a> 👀, give the docs a <a href=${githubUrl}>star 🌟</a> if they helped. As always, live in the mix!`,
        },
        {
          html: `
